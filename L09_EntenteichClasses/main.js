...
(function (L09_EntenteichClasses) {
    ...
    function handleLoad(_event) {
        ...
        drawPond();
        let pondArea = {
            x: (L09_EntenteichClasses.crc2.canvas.width - 700) / 2,
            y: L09_EntenteichClasses.crc2.canvas.height * 0.7 - 200 / 2,
            width: 700,
            height: 200
        };
        const ducks = [];
        ducks.push(new L09_EntenteichClasses.Duck({ x: pondArea.x + 50, y: pondArea.y + 50 }, pondArea));
        ducks.push(new L09_EntenteichClasses.Duck({ x: pondArea.x + 150, y: pondArea.y + 150 }, pondArea));
        ducks.push(new L09_EntenteichClasses.Duck({ x: pondArea.x + 250, y: pondArea.y + 100 }, pondArea));
