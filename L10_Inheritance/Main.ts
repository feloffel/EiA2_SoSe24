namespace L09_EntenteichClasses {
    ...
    function handleLoad(_event: Event): void {
        ...
        const ducks: Duck[] = [];
        ducks.push(new Duck(new Vector(pondArea.x + 50, pondArea.y + 50), pondArea));
        ducks.push(new Duck(new Vector(pondArea.x + 150, pondArea.y + 150), pondArea));
        ducks.push(new Duck(new Vector(pondArea.x + 250, pondArea.y + 100), pondArea));
