...
(function (L09_EntenteichClasses) {
    ...
    function handleCanvasClick(event) {
        let rect = L09_EntenteichClasses.crc2.canvas.getBoundingClientRect();
        let x = event.clientX - rect.left;
        let y = event.clientY - rect.top;
        currentBreadcrumb = new L09_EntenteichClasses.Vector(x, y);
        let crumb = new L09_EntenteichClasses.Breadcrumb(currentBreadcrumb);
